  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.contentContainer}>
        {viewMode === 'calendar' ? (
          // KALENDER-ANSICHT (BookingCalendar hat eigenes Scrolling)
          <BookingCalendar 
            courts={courts} 
            onBooking={handleBooking}
            canBookPublic={canBookPublic()}
            vereinId={currentVereinId}  // ✅ Verein-ID weiterleiten
          />
        ) : (
          // ✅ LISTEN-ANSICHT mit ScrollView - OHNE Permission Info
          <ScrollView 
          ...
          >
            ...
            {/* ❌ PERMISSION INFO KOMPLETT ENTFERNT */}
...
const styles = StyleSheet.create({
  ...
  // ✅ SCROLLABLE CONTENT mit fester Height wie im CRM (nur für Listen-Ansicht)
  content: {
    flex: 1,
    padding: 20,
