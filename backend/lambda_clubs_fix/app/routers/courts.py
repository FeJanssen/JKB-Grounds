...
@router.get("/list")
async def get_courts_list(club_id: str = "fab28464-e42a-4e6e-b314-37eea1e589e6"):
    """Courts list endpoint for frontend compatibility - maps club_id to verein_id"""
    try:
        courts = await courts_service.get_courts_by_verein(club_id)
