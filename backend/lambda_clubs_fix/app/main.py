...
from app.routers import clubs  # ← NEU HINZUFÜGEN für Frontend-Kompatibilität

app = FastAPI(title="JKB Grounds API", version="1.0.0")

# CORS wird durch AWS Lambda Function URL gehandhabt
# FastAPI CORS-Middleware deaktiviert um Duplikate zu vermeiden
...
app.include_router(clubs.router)  # ← NEU: Clubs-Router für Frontend
